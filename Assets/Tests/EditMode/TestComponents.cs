...
{
    private readonly RefRW<Character> m_Character;
...
internal struct EcsTestData6 : IComponentData
{
    public int value;
}

internal struct EcsTestData7 : IComponentData
{
    public int value;
}

internal struct EcsTestData8 : IComponentData
{
    public int value;
}

internal struct EcsTestData9 : IComponentData
{
    public int value;
}

internal struct EcsTestData10 : IComponentData
{
    public int value;
}

internal struct EcsTestData11 : IComponentData
{
    public int value;
}
...
internal struct EcsTestSharedCompManaged : ISharedComponentData, IEquatable<EcsTestSharedCompManaged>
{
    ...
    public EcsTestSharedCompManaged(string inValue)
    {
        value = inValue;
    }

    public bool Equals(EcsTestSharedCompManaged other)
    {
...
internal struct EcsTestSharedCompManaged2 : ISharedComponentData, IEquatable<EcsTestSharedCompManaged2>
{
    ...
    public EcsTestSharedCompManaged2(string inValue)
    {
        value0 = value1 = inValue;
    }

    public bool Equals(EcsTestSharedCompManaged2 other)
    {
    ...
    public override int GetHashCode()
    {
        return value0.GetHashCode() ^ value1.GetHashCode();
    }
}
...
internal struct EcsTestSharedCompManaged3 : ISharedComponentData, IEquatable<EcsTestSharedCompManaged3>
{
    ...
    public EcsTestSharedCompManaged3(string inValue)
    {
        value0 = value1 = value2 = inValue;
    }

    public bool Equals(EcsTestSharedCompManaged3 other)
    {
    ...
    public override int GetHashCode()
    {
        return value0.GetHashCode() ^ value1.GetHashCode() ^ value2.GetHashCode();
    }
}
...
internal struct EcsTestSharedCompWithMaxChunkCapacity : ISharedComponentData
{
    public int Value;
...
internal class EcsTestManagedCompWithRefCount : IComponentData, ICloneable, IDisposable
{
    public int RefCount;
...
internal partial struct EcsTestSetFirstComponentValueTo10WithSharedComponent : IJobEntity
{
    public void Execute(ref EcsTestData ecsTestData, ref EcsTestData2 ecsTestData2)
    {
        ecsTestData = new EcsTestData {value = 10};
